...
export default function ProjectCard({ project, index }: ProjectCardProps) {
  return (
    <article className="relative overflow-hidden rounded-cottageLg border border-line bg-surface shadow-soft p-8 md:p-10">
      {/* Background Number */}
      ...
      <div className="grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          <p className="text-muted leading-8 mb-6">{project.description}</p>
